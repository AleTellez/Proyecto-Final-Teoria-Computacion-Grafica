...
const int MAX_POINT_LIGHTS = 8; //Sirve para que como usuario sepamos el limite de luces 
const int MAX_SPOT_LIGHTS = 8; //Son 8 luces max, menos 1 (..) quedan 7 luces para ocupar 
