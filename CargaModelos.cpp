...
int main()
{
	...
	Blackhawk_M = Model();
	Blackhawk_M.LoadModel("Models/cofre.obj"); 
	Camino_M = Model();
	Camino_M.LoadModel("Models/carroceria.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glm::vec3 color = glm::vec3(0.0f, 0.4f, 0.4f);
		...
		glm::vec3 arenoso = glm::vec3(1.0f, 0.5f, 0.0f);

		//CARRO PROPIO
		//carroceria
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(75.0f, -1.53f, -200.0f));
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, mainWindow.getavanzacarro1()));
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, mainWindow.getretrocedecarro1()));
		modelaux = model;
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, mainWindow.getavanzacarro2()));
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, mainWindow.getretrocedecarro2()));
		modelaux = model;
